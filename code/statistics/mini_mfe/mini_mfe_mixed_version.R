...
# This script is based on the fixing_dPrime script and is going to reorganize the code for mixed effects analyses.
...
percent_mainDat <- setNames(data.frame(matrix(ncol = 81, nrow = 0)), c("id", "congAcc", "incongAcc", "congCorr_meanRT", "incongCorr_meanRT", "congCorr_logMeanRT", "incongCorr_logMeanRT",
                                                                       "flankEff_meanACC", "flankEff_meanRT", "flankEff_logMeanRT",
                                                                       "reported_errors", "committed_errors", "memoryBias_score",
                                                                       ...
                                                                       "criterion_error", "pre_criterion_error", "post_criterion_error", "criterion_correct", "pre_criterion_correct", "post_criterion_correct", "gen_hit", "num_incong_errors", "d_prime_error_minus_correct" ,"post_d_prime_error_minus_correct", "unfriendly_error_minus_correct", "unfriendly_post_error_minus_correct", "overall_acc", "post_error_rt_mean", "post_error_rt_sd", "post_correct_rt_mean", "post_correct_rt_sd", "post_error_slowing_score",
                                                                       ...
                                                                       "d_prime_overall", "overall_hit", "overall_falseAlarm", "num_oldFaces_identified_correctly", "num_newFaces_identified_correctly", "num_faces_identified_correctly"))
...
for(i in 1:length(datafiles_list)){
  ...
  if (d_prime_overall >= d_prime_based_outlier){
    ...
    if (nrow(incong_errorDat) >= outlier_num){ #for when the participant has outlier_num or more than outlier_num incongruent errors
      ...
      percent_mainDat[nrow(percent_mainDat) + 1,] <-c(id, congAcc, incongAcc, congCorr_meanRT, incongCorr_meanRT, congCorr_logMeanRT, incongCorr_logMeanRT, flankEff_meanACC, flankEff_meanRT, flankEff_logMeanRT, reported_errors, committed_errors, memoryBias_score, percent_incong_errorFaces_reported_old,
                                                      percent_incong_errorFaces_reported_new,percent_incong_corrFaces_reported_old, percent_incong_corrFaces_reported_new, percent_foilFaces_reported_new, percent_foilFaces_reported_old,
                                                      percent_incong_errorFaces_reported_friendly, percent_incong_errorFaces_reported_unfriendly, percent_incong_corrFaces_reported_friendly, percent_incong_corrFaces_reported_unfriendly,
                                                      percent_post_incong_errorFaces_reported_old, percent_post_incong_errorFaces_reported_new, percent_post_incong_correctFaces_reported_old, percent_post_incong_correctFaces_reported_new,
                                                      percent_pre_incong_errorFaces_reported_old, percent_pre_incong_errorFaces_reported_new, percent_pre_incong_correctFaces_reported_old, percent_pre_incong_correctFaces_reported_new, percent_post_incong_errorFaces_reported_friendly,
                                                      percent_post_incong_errorFaces_reported_unfriendly, percent_post_incong_correctFaces_reported_friendly, percent_post_incong_correctFaces_reported_unfriendly, percent_pre_incong_errorFaces_reported_friendly, percent_pre_incong_errorFaces_reported_unfriendly,
                                                      percent_pre_incong_correctFaces_reported_friendly, percent_pre_incong_correctFaces_reported_unfriendly, errorFaces_hit, pre_errorFaces_hit, post_errorFaces_hit, correctFaces_hit, pre_correctFaces_hit, post_correctFaces_hit, falseAlarm_for_both, d_prime_error, pre_d_prime_error,
                                                      post_d_prime_error, d_prime_correct, pre_d_prime_correct, post_d_prime_correct, criterion_error, pre_criterion_error, post_criterion_error, criterion_correct, pre_criterion_correct, post_criterion_correct, gen_hit, num_incong_errors, d_prime_error_minus_correct ,post_d_prime_error_minus_correct,
                                                      unfriendly_error_minus_correct, unfriendly_post_error_minus_correct, overall_acc, post_error_rt_mean, post_error_rt_sd, post_correct_rt_mean, post_correct_rt_sd, post_error_slowing_score, post_error_accuracy_mean, post_error_accuracy_sd,
                                                      post_correct_accuracy_mean, post_correct_accuracy_sd, post_error_accuracy_score, d_prime_overall, overall_hit, overall_falseAlarm, num_oldFaces_identified_correctly, num_newFaces_identified_correctly, num_faces_identified_correctly)
...
longDat_mixed <- gather(percent_mainDat, column_name, value, pre_d_prime_error, d_prime_error, post_d_prime_error, pre_d_prime_correct, d_prime_correct, post_d_prime_correct)
...
#
t.test((as.numeric(percent_mainDat$d_prime_correct)), (as.numeric(percent_mainDat$d_prime_error)), paired = TRUE)
...
t.test((as.numeric(percent_mainDat$errorFaces_hit)), (as.numeric(percent_mainDat$correctFaces_hit)), paired = TRUE)
t.test((as.numeric(percent_mainDat$pre_errorFaces_hit)), (as.numeric(percent_mainDat$pre_correctFaces_hit)), paired = TRUE)
t.test((as.numeric(percent_mainDat$post_errorFaces_hit)), (as.numeric(percent_mainDat$post_correctFaces_hit)), paired = TRUE)
