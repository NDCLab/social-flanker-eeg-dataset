...
# Last Update: 2022-10-21 (YYYY-MM-DD)
...
percent_mainDat <- setNames(data.frame(matrix(ncol = 75, nrow = 0)), c("id", "congAcc", "incongAcc", "congCorr_meanRT", "incongCorr_meanRT", "congCorr_logMeanRT", "incongCorr_logMeanRT",
                                                                       "flankEff_meanACC", "flankEff_meanRT", "flankEff_logMeanRT",
                                                                       "reported_errors", "committed_errors", "memoryBias_score",
                                                                       ...
                                                                       "d_prime_error_minus_correct" ,"post_d_prime_error_minus_correct", "unfriendly_error_minus_correct",
                                                                       "unfriendly_post_error_minus_correct", "post_error_rt_mean", "post_error_rt_sd", "post_correct_rt_mean", "post_correct_rt_sd",
                                                                       "post_error_slowing_score", "post_error_accuracy_mean", "post_error_accuracy_sd",
                                                                       "post_correct_accuracy_mean", "post_correct_accuracy_sd", "post_error_accuracy_score", "d_prime_overall"))
...
for(i in 1:length(datafiles_list)){
  ...
  # Participants with less than 6 incong errors are considered outliers. This may be updated according to the data mean and SD.
  outlier_num <- 6
  if (nrow(incong_errorDat) >= outlier_num){ #for when the participant has outlier_num or more than outlier_num incongruent errors
    ...
    d_prime_based_outlier <- 0.7359175 - 0.398124 # mean - 1SD below mean!
    ...
    percent_mainDat[nrow(percent_mainDat) + 1,] <-c(id, congAcc, incongAcc, congCorr_meanRT, incongCorr_meanRT, congCorr_logMeanRT,
                                                    ...
                                                    percent_foilFaces_reported_old, percent_incong_errorFaces_reported_friendly, percent_incong_errorFaces_reported_unfriendly,
                                                    percent_incong_corrFaces_reported_friendly, percent_incong_corrFaces_reported_unfriendly, percent_post_incong_errorFaces_reported_old,
                                                    ...
                                                    percent_pre_incong_correctFaces_reported_old, percent_pre_incong_correctFaces_reported_new, percent_post_incong_errorFaces_reported_friendly,
                                                    percent_post_incong_errorFaces_reported_unfriendly, percent_post_incong_correctFaces_reported_friendly,
                                                    percent_post_incong_correctFaces_reported_unfriendly, percent_pre_incong_errorFaces_reported_friendly,
                                                    percent_pre_incong_errorFaces_reported_unfriendly, percent_pre_incong_correctFaces_reported_friendly,
                                                    percent_pre_incong_correctFaces_reported_unfriendly, errorFaces_hit, pre_errorFaces_hit, post_errorFaces_hit, correctFaces_hit,
                                                    ...
                                                    post_d_prime_error_minus_correct, unfriendly_error_minus_correct, unfriendly_post_error_minus_correct,
...
ggplot(percent_mainDat, aes(x=memoryBias_score, y=d_prime_error_minus_correct)) + geom_point() #scatterplot
ggplot(percent_mainDat, aes(x=memoryBias_score, y=post_d_prime_error_minus_correct)) + geom_point() #scatterplot