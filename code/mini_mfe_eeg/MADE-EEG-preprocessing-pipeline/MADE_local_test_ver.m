...
main_dir = '/Users/kihossei/OneDrive - Florida International University/Projects/sfe/scripts/sfe-dataset'; %directory on the HPC
...
%Location of EEGlab
addpath(genpath([main_dir filesep 'scripts' filesep 'eeglab2022.1']));% enter the path of the EEGLAB folder in this line

%remove path to octave functions inside matlab to prevent errors when
rmpath([main_dir filesep 'scripts' filesep 'eeglab2022.1' filesep 'functions' filesep 'octavefunc' filesep 'signal'])
...
channel_locations = [main_dir filesep 'scripts' filesep 'MADE-EEG-preprocessing-pipeline' filesep 'chan_locs_files' filesep 'CACS-128-X7-FIXED-64only.bvef'];
