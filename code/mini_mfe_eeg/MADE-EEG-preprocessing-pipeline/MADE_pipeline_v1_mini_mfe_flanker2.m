...
rawdata_location = [main_dir filesep 'sourcedata' filesep 'raw' filesep 'mini_mfe_eeg'];
...
stimulus_timeoffset   = 13.15; % stimulus related time offset (in milliseconds). 0 = No time offset
