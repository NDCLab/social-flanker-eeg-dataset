...
for subject=37:37 % As 160020 (the 6th data) gave an error due to an empty vhdr file. I restart it from the 7th subject.
    % I restart it because of 160038! the same for 160059 (37th). 
