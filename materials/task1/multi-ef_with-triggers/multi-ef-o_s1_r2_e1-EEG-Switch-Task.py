...
expName = 'multiEF-Switch'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Alycia Winters\\Documents\\NDC Lab\\SC-EEG\\multi-ef-o_s1_r2_e1-master - EEG Study Test Copy\\multi-ef-o_s1_r2_e1-master_EEG-Test\\multi-ef-o_s1_r2_e1-EEG-Switch-Task.py',
...
prac_BlockLoop = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('switch_practiceblockSelect.csv'),
...
blockLoop = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('switchblockSelect.csv'),
