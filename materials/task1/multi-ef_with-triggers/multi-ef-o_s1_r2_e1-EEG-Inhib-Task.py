...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/khoss005/OneDrive - Florida International University/Psychopy/EF_try/EF_TRY/multi-ef-o_s1_r2_e1-EEG-Inhib-Task.py',
        ...
        for thisPrac_stimLoop in prac_stimLoop:
            ...
            while continueRoutine:
                ...
                if centerPresented_2.status == STARTED and not pulse_started:
                    port.write([0x01])# Becca: "S1 Trigger" - for stimulus presentation. 
                    pulse_start_time = globalClock.getTime()
                    pulse_started = True
                if pulse_started and not pulse_ended:
                    if globalClock.getTime() - pulse_start_time >= 0.005:
    ...
    for thisTrialLoop in trialLoop:
        ...
        for thisStimLoop in stimLoop:
            ...
            while continueRoutine:
                ...
                #3
                if centerPresented.status == STARTED and not pulse_started:
                    port.write([0x01])# Becca: "S1 Trigger" - for stimulus presentation. 
                    pulse_start_time = globalClock.getTime()
                    pulse_started = True
                if pulse_started and not pulse_ended:
