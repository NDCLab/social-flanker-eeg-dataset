...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Multi_EF_with_ALL_triggers\\multi-ef-o_s1_r2_e1-EEG_Practice_Blocks_lastrun.py',
...
blockLoop = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('practiceblockSelect.csv'),
...
for thisBlockLoop in blockLoop:
    ...
    for thisTrialLoop in trialLoop:
        ...
        if trialLoop.thisN == 0 or trialLoop.thisN % 16 != 0:
            continueRoutine = False
        text.setText('You may take a short break\n\nPress space to continue')
        key_resp_3.keys = []
        key_resp_3.rt = []
        _key_resp_3_allKeys = []
        # keep track of which components have finished
