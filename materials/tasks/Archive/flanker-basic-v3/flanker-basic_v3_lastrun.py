...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\NDClab\\Desktop\\Experiments\\putt-putt-miss\\flanker-basic-v3\\flanker-basic_v3_lastrun.py',
...
welcome_text = visual.TextStim(win=win, name='welcome_text',
    ...
    languageStyle='LTR',
    depth=0.0);
welcome_centerImg = visual.ImageStim(
    win=win,
    name='welcome_centerImg', 
    image='img/rightArrow.png', mask=None,
    ori=0, pos=(0, -.3), size=(.04, .04),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-1.0)
welcome_rightImg1 = visual.ImageStim(
    win=win,
    name='welcome_rightImg1', 
    image='img/rightArrow.png', mask=None,
    ori=0, pos=(.05, -.3), size=(.04, .04),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-2.0)
welcome_rightImg2 = visual.ImageStim(
    win=win,
    name='welcome_rightImg2', 
    image='img/rightArrow.png', mask=None,
    ori=0, pos=(.1, -.3), size=(.04, .04),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-3.0)
welcome_leftImg1 = visual.ImageStim(
    win=win,
    name='welcome_leftImg1', 
    image='img/rightArrow.png', mask=None,
    ori=0, pos=(-.05, -.3), size=(.04, .04),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-4.0)
welcome_leftImg2 = visual.ImageStim(
    win=win,
    name='welcome_leftImg2', 
    image='img/rightArrow.png', mask=None,
    ori=0, pos=(-.1, -.3), size=(.04, .04),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
# Initialize components for Routine "instructMainTask"
instructMainTaskClock = core.Clock()
instructMainTask_text = visual.TextStim(win=win, name='instructMainTask_text',
    text='You will now begin the actual game. \n\nPress the right button to continue',
    font='Arial',
    pos=(0, 0), height=0.03, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
# keep track of which components have finished
welcomeComponents = [welcome_text, welcome_centerImg, welcome_rightImg1, welcome_rightImg2, welcome_leftImg1, welcome_leftImg2, welcome_keyResp]
...
while continueRoutine:
    ...
    # *welcome_centerImg* updates
    if welcome_centerImg.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        welcome_centerImg.frameNStart = frameN  # exact frame index
        welcome_centerImg.tStart = t  # local t and not account for scr refresh
        welcome_centerImg.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(welcome_centerImg, 'tStartRefresh')  # time at next scr refresh
        welcome_centerImg.setAutoDraw(True)
    
    # *welcome_rightImg1* updates
    if welcome_rightImg1.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        welcome_rightImg1.frameNStart = frameN  # exact frame index
        welcome_rightImg1.tStart = t  # local t and not account for scr refresh
        welcome_rightImg1.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(welcome_rightImg1, 'tStartRefresh')  # time at next scr refresh
        welcome_rightImg1.setAutoDraw(True)
    
    # *welcome_rightImg2* updates
    if welcome_rightImg2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        welcome_rightImg2.frameNStart = frameN  # exact frame index
        welcome_rightImg2.tStart = t  # local t and not account for scr refresh
        welcome_rightImg2.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(welcome_rightImg2, 'tStartRefresh')  # time at next scr refresh
        welcome_rightImg2.setAutoDraw(True)
    
    # *welcome_leftImg1* updates
    if welcome_leftImg1.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        welcome_leftImg1.frameNStart = frameN  # exact frame index
        welcome_leftImg1.tStart = t  # local t and not account for scr refresh
        welcome_leftImg1.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(welcome_leftImg1, 'tStartRefresh')  # time at next scr refresh
        welcome_leftImg1.setAutoDraw(True)
    
    # *welcome_leftImg2* updates
    if welcome_leftImg2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        welcome_leftImg2.frameNStart = frameN  # exact frame index
        welcome_leftImg2.tStart = t  # local t and not account for scr refresh
        welcome_leftImg2.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(welcome_leftImg2, 'tStartRefresh')  # time at next scr refresh
        welcome_leftImg2.setAutoDraw(True)
...
for thisPrac_block_loop in prac_block_loop:
    ...
    # keep track of which components have finished
    prac_blockRemindersComponents = [prac_reminder_text, prac_reminder_keyResp]
    ...
    # set up handler to look after randomisation of conditions etc
    prac_trial_loop = data.TrialHandler(nReps=8, method='random', 
        extraInfo=expInfo, originPath=-1,
    ...
    # completed 8 repeats of 'prac_trial_loop'
    ...
    if blockAcc >= .75: #if accuracy >= 75% then say practice is complete and end practice loop to continue to main exp
        outPut = 'You have completed the practice. Press the right button to continue.' #feedback presented
        ...
        outPut = 'Please try the practice again. Press the right button.' #feedback presented
    ...
    # keep track of which components have finished
    prac_blockFeedComponents = [prac_blockFeed_text, prac_blockFeed_keyResp]
...
# ------Prepare to start Routine "instructMainTask"-------
continueRoutine = True
# update component parameters for each repeat
...
# keep track of which components have finished
instructMainTaskComponents = [instructMainTask_text, instructMainTask_keyResp]
for thisComponent in instructMainTaskComponents:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
instructMainTaskClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "instructMainTask"-------
while continueRoutine:
    # get current time
    t = instructMainTaskClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=instructMainTaskClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
# -------Ending Routine "instructMainTask"-------
for thisComponent in instructMainTaskComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
...
thisExp.nextEntry()
# the Routine "instructMainTask" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
for thisTask_block_loop in task_block_loop:
    ...
    # set up handler to look after randomisation of conditions etc
    task_trial_loop = data.TrialHandler(nReps=12.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('task_trials.xlsx'),
    ...
    # completed 12.0 repeats of 'task_trial_loop'
    ...
    if blockCounter < 10:
        if blockAcc >= .75:
            if blockAcc < .9:
                ...
                blockFeed = 'Please respond faster'
                blockFeedCat = 2
        elif blockAcc < .75:
            blockFeed = 'Please respond more accurately'
            blockFeedCat = 3
    elif blockCounter == 10:
    ...
    while continueRoutine:
        ...
        if task_blockFeed_text2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
        ...
        waitOnFlip = False
        if task_blockFeed_keyResp.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
