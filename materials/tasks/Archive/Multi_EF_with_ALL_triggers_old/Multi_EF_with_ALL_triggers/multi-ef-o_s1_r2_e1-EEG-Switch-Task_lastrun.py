...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\NDClab\\Desktop\\social-context-eeg\\Multi_EF_with_ALL_triggers\\multi-ef-o_s1_r2_e1-EEG-Switch-Task_lastrun.py',
...
for thisBlockLoop in blockLoop:
    ...
    for thisTrialLoop in trialLoop:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        if trialLoop.thisN == 0 or trialLoop.thisN % 64 != 0:
            continueRoutine = False
    ...
    # update component parameters for each repeat
    if practice == 1:
        taskEnd_text_source ='You have completed the practice session. \n \n \n \n \n \n \n \n \n \n Press the left or right button to continue to the real game'
    elif practice == 0:
