...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\NDClab\\Desktop\\Experiments\\social-flanker-eeg\\flanker-basic-v4\\flanker-basic_v4_lastrun.py',
...
# set up handler to look after randomisation of conditions etc
task_block_loop = data.TrialHandler(nReps=4.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
...
# completed 4.0 repeats of 'task_block_loop'
