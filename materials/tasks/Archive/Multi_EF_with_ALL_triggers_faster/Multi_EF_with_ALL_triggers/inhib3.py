...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Volumes/KIANOOSH8/Test_exps2/Test_exps/EF_try/EF_TRY/inhib3.py',
...
for thisPrac_BlockLoop in prac_BlockLoop:
    ...
    for thisPrac_trialLoop in prac_trialLoop:
        ...
        for thisPrac_stimLoop in prac_stimLoop:
            ...
            postTriggerPauseTime_1 = 0.03
            pauseStartTime_1 = 0
            triggerSent_1 = False
            portsCleared_1 = False
            postTriggerPauseTime_01 = 0.07
            pauseStartTime_01 = 0
            triggerSent_01 = False
            portsCleared_01 = False
            ...
            while continueRoutine:
                ...
                if centerPresented_2.status == STARTED and not triggerSent_1:#
                    if rotCenter == 0:
                        ...
                        port.write([0x34])# send different trigger
                        triggerSent_1 = True
                        triggerSent_01 = True
                        #portsCleared_1 = False
                        pauseStartTime_1 = t
                ...
                if triggerSent_1 and not portsCleared_1:
                    if t > (pauseStartTime_1 + postTriggerPauseTime_1):
                        if male == 0:
                            port.write([0x48])# send a trigger
                            triggerSent_1 = False
                            portsCleared_1 = True
                        elif male ==1:
                            port.write([0x58])
                            ...
                            portsCleared_1 = True
                #
                #if triggerSent_01 and not portsCleared_01:
                #    if t > (pauseStartTime_01 + postTriggerPauseTime_01):
                #        # Clear ports
                #        port.write([0xFF])
                #        triggerSent_01 = False
                #        portsCleared_01 = True
