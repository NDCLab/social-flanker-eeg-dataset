...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Alycia Winters\\Documents\\NDC Lab\\SC-EEG\\Multi_EF_with_ALL_triggers\\multi-ef-o_s1_r2_e1-EEG_Practice_Blocks_lastrun.py',
    ...
    for thisShapetrialLoop in shapetrialLoop:
        ...
        for thisShapecueLoop in shapecueLoop:
            ...
            for thisComponent in cueRoutineComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            shapecueLoop.addData('LeftReminder_text_3.started', LeftReminder_text_3.tStartRefresh)
            shapecueLoop.addData('LeftReminder_text_3.stopped', LeftReminder_text_3.tStopRefresh)
            shapecueLoop.addData('rightReminder_text_3.started', rightReminder_text_3.tStartRefresh)
            shapecueLoop.addData('rightReminder_text_3.stopped', rightReminder_text_3.tStopRefresh)
            shapecueLoop.addData('cuePresented.started', cuePresented.tStartRefresh)
            shapecueLoop.addData('cuePresented.stopped', cuePresented.tStopRefresh)
            #4
        ...
        for thisShapeStimLoop in shapeStimLoop:
            ...
            for thisComponent in StimRoutineComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            shapeStimLoop.addData('LeftReminder_text_4.started', LeftReminder_text_4.tStartRefresh)
            shapeStimLoop.addData('LeftReminder_text_4.stopped', LeftReminder_text_4.tStopRefresh)
            shapeStimLoop.addData('rightReminder_text_4.started', rightReminder_text_4.tStartRefresh)
            shapeStimLoop.addData('rightReminder_text_4.stopped', rightReminder_text_4.tStopRefresh)
            shapeStimLoop.addData('centerPresented.started', centerPresented.tStartRefresh)
            shapeStimLoop.addData('centerPresented.stopped', centerPresented.tStopRefresh)
            shapeStimLoop.addData('topPresented.started', topPresented.tStartRefresh)
            shapeStimLoop.addData('topPresented.stopped', topPresented.tStopRefresh)
            shapeStimLoop.addData('rightPresented.started', rightPresented.tStartRefresh)
            shapeStimLoop.addData('rightPresented.stopped', rightPresented.tStopRefresh)
            shapeStimLoop.addData('bottomPresented.started', bottomPresented.tStartRefresh)
            shapeStimLoop.addData('bottomPresented.stopped', bottomPresented.tStopRefresh)
            shapeStimLoop.addData('leftPresented.started', leftPresented.tStartRefresh)
            shapeStimLoop.addData('leftPresented.stopped', leftPresented.tStopRefresh)
            #4
            ...
            shapeStimLoop.addData('keyResp.keys',keyResp.keys)
            shapeStimLoop.addData('keyResp.corr', keyResp.corr)
            if keyResp.keys != None:  # we had a response
                shapeStimLoop.addData('keyResp.rt', keyResp.rt)
            shapeStimLoop.addData('keyResp.started', keyResp.tStartRefresh)
            shapeStimLoop.addData('keyResp.stopped', keyResp.tStopRefresh)
            #4
            if not keyResp.keys or len(keyResp.keys) == 0:
                   port.write([0x03])# send a trigger
                   time.sleep(PulseWidth)
    ...
    for thisSwitchtrialLoop in switchtrialLoop:
        ...
        for thisSwitchStimLoop in switchStimLoop:
            ...
            for thisComponent in StimRoutineComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            switchStimLoop.addData('LeftReminder_text_4.started', LeftReminder_text_4.tStartRefresh)
            switchStimLoop.addData('LeftReminder_text_4.stopped', LeftReminder_text_4.tStopRefresh)
            switchStimLoop.addData('rightReminder_text_4.started', rightReminder_text_4.tStartRefresh)
            switchStimLoop.addData('rightReminder_text_4.stopped', rightReminder_text_4.tStopRefresh)
            switchStimLoop.addData('centerPresented.started', centerPresented.tStartRefresh)
            switchStimLoop.addData('centerPresented.stopped', centerPresented.tStopRefresh)
            switchStimLoop.addData('topPresented.started', topPresented.tStartRefresh)
            switchStimLoop.addData('topPresented.stopped', topPresented.tStopRefresh)
            switchStimLoop.addData('rightPresented.started', rightPresented.tStartRefresh)
            switchStimLoop.addData('rightPresented.stopped', rightPresented.tStopRefresh)
            switchStimLoop.addData('bottomPresented.started', bottomPresented.tStartRefresh)
            switchStimLoop.addData('bottomPresented.stopped', bottomPresented.tStopRefresh)
            switchStimLoop.addData('leftPresented.started', leftPresented.tStartRefresh)
            switchStimLoop.addData('leftPresented.stopped', leftPresented.tStopRefresh)
            #4
            ...
            switchStimLoop.addData('keyResp.keys',keyResp.keys)
            switchStimLoop.addData('keyResp.corr', keyResp.corr)
            if keyResp.keys != None:  # we had a response
                switchStimLoop.addData('keyResp.rt', keyResp.rt)
            switchStimLoop.addData('keyResp.started', keyResp.tStartRefresh)
            switchStimLoop.addData('keyResp.stopped', keyResp.tStopRefresh)
            #4
            if not keyResp.keys or len(keyResp.keys) == 0:
                   port.write([0x03])# send a trigger
                   time.sleep(PulseWidth)
