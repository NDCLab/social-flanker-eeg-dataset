...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\NDClab\\Desktop\\social-context-eeg\\Multi_EF_with_ALL_triggers_faster\\Multi_EF_with_ALL_triggers\\multi-ef-o_s1_r2_e1-EEG_Practice_Blocks_faster_lastrun.py',
        ...
        for thisSwitchCueLoop in switchCueLoop:
            ...
            while continueRoutine:
                ...
                if cuePresented_3.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > cuePresented_3.tStartRefresh + .5-frameTolerance:
                        # keep track of stop time/frame for later
        ...
        for thisSwitchStimLoop in switchStimLoop:
            ...
            while continueRoutine:
                ...
                if centerPresented_3.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > centerPresented_3.tStartRefresh + .5-frameTolerance:
                        # keep track of stop time/frame for later
                ...
                if topPresented_3.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > topPresented_3.tStartRefresh + .5-frameTolerance:
                        # keep track of stop time/frame for later
                ...
                if rightPresented_3.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > rightPresented_3.tStartRefresh + .5-frameTolerance:
                        # keep track of stop time/frame for later
                ...
                if bottomPresented_3.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > bottomPresented_3.tStartRefresh + .5-frameTolerance:
                        # keep track of stop time/frame for later
                ...
                if leftPresented_3.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > leftPresented_3.tStartRefresh + .5-frameTolerance:
                        # keep track of stop time/frame for later
                ...
                if keyResp_3.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > keyResp_3.tStartRefresh + .5-frameTolerance:
                        # keep track of stop time/frame for later
